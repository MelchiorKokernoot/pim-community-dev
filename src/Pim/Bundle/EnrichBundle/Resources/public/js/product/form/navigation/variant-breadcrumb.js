...
define([
        ...
        'pim/template/product/form/navigation/variant-product',
        'pim/template/product/form/navigation/variant-product-model'
    ],
    function (
        $,
        _,
        ...
        return BaseForm.extend({
            className: 'AknProductVariantBreadcrumb',
            ...
            render: function () {
                ...
                const nbOfLevels = _.isEmpty(entity.meta.navigation.level_two.axes) ? 1 : 2;
                let currentLevel = 0;

                if (null !== entity.parent) {
                    currentLevel = (entity.parent === entity.meta.navigation.root.identifier) ? 1 : 2;
                }
                ...
                this.$el.empty().append(
                    this.template({
                        ...
                        navigation: entity.meta.navigation,
            ...
            initializeSelectWidgets: function () {
                ...
                const commonOptions = {
                    dropdownCssClass: 'product-variant-breadcrumb',
                    closeOnSelect: false,
                ...
                const optionsLevelOne = $.extend(true, {
                    query: (options) => {
                        this.queryChildrenEntities(
                            options,
                            entity.meta.navigation.root.id
                        );
                    }
                }, commonOptions);
                ...
                if (null !== entity.meta.navigation.level_one.selected) {
                    const optionsLevelTwo = $.extend(true, {
                        query: (options) => {
                            this.queryChildrenEntities(
                                options,
                                entity.meta.navigation.level_one.selected.id
                            )
                        }
                    }, commonOptions);
            ...
            queryChildrenEntities: function (options, parentId) {
                ...
                this.queryTimer = setTimeout(() => {
                    FetcherRegistry
                        .getFetcher('entity-with-family-variant')
            ...
            redirectToRoot: function () {
                const entity = this.getFormData();
                this.redirectToEntity(entity.meta.navigation.root)
            },
            ...
            redirectToModel: function () {
                const entity = this.getFormData();
                this.redirectToEntity(entity.meta.navigation.level_one.selected)
            },
